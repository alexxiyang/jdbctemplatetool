...
public class JdbcTemplateTool {
	...
	public void update(Object po) throws Exception {
		...
		this.getJdbcTemplate().update(sqlAndParams.getSql(), sqlAndParams.getParams());
	}
	...
	private int save(Object po, String autoGeneratedColumnName) throws Exception {
		...
		jdbcTemplate.update(new ReturnIdPreparedStatementCreator(sqlAndParams.getSql(), sqlAndParams.getParams(), autoGeneratedColumnName), keyHolder);
